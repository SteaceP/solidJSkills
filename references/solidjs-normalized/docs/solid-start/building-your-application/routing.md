...
- **[API routes](api-routes.md)** &mdash; define the serverless functions in your app
...
SolidStart traverses your `routes` directory, collects all of the routes, and then makes them accessible using the [`<FileRoutes />`](../reference/routing/file-routes.md).
...
In this example, we use [`solid-router`](../../solid-router/index.md):
