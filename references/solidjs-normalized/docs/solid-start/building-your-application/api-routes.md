...
API routes are just similar to other routes and follow the same filename conventions as [UI Routes](routing.md).
...
For more information on how to use cookies for secure session management, read the [session documentation](../advanced/session.md).
