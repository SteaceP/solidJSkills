...
[Solid](/) and [Solid Router](../../solid-router/index.md) provide foundational tools like the [`createResource` primitive](../../guides/fetching-data.md) and [queries](../../solid-router/data-fetching/queries.md) to manage asynchronous data.
...
If you are a beginner, we highly recommend starting with the [queries documentation](../../solid-router/data-fetching/queries.md).
You can also find many practical examples in the [data fetching how-to guide](../guides/data-fetching.md).
