...
[Solid Router](../../solid-router/index.md) provides [actions](../../solid-router/concepts/actions.md) to manage data mutations effectively.
...
If you are a beginner, we highly recommend starting with the [actions documentation](../../solid-router/concepts/actions.md).
You can also find many practical examples in the [data mutation how-to guide](../guides/data-mutation.md).
