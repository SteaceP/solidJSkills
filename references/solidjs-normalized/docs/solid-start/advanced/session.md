...
It is strongly recommended to store this password in a [private environment variable](../../configuration/environment-variables.md#private-environment-variables), as shown in the example above, rather than hardcoding it in your source code.
