...
[`solid-router`](../../solid-router/index.md) knows how to handle certain responses with its [`query`](../../solid-router/reference/data-apis/query.md) and [`action`](../../solid-router/reference/data-apis/action.md) APIs.
