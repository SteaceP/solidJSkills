...
```
See the full config reference in [`defineConfig`](../reference/config/define-config.md#serialization).
...
- Configure modes and defaults in [`defineConfig`](../reference/config/define-config.md#serialization).
- CSP implications and nonce examples live in the [Security guide](../guides/security.md#content-security-policy-csp).
