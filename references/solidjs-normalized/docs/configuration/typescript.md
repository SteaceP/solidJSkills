...
[`createMemo`](../reference/basic-reactivity/create-memo.md),
[`createRenderEffect`](../reference/secondary-primitives/create-render-effect.md),
and [`createComputed`](../reference/secondary-primitives/create-computed.md).
:::
