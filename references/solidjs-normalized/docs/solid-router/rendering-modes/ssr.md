...
In addition, it has Solid's transitions included, so it can be used freely with [suspense](../../reference/components/suspense.md), [resources](../../reference/basic-reactivity/create-resource.md), and [lazy components](../../reference/component-apis/lazy.md).
