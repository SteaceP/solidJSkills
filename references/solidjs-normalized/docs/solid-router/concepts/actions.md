...
- **Automatic data revalidation:**
  After an action successfully completes, Solid Router revalidates relevant [`queries`](../data-fetching/queries.md), ensuring the UI reflects the latest data.
...
Actions can be triggered in two ways: using an HTML [`<form>` element](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/form) or programmatically using the [`useAction` primitive](../reference/data-apis/use-action.md).
...
To access this state, Solid Router provides the [`useSubmission`](../reference/data-apis/use-submission.md) and [`useSubmissions`](../reference/data-apis/use-submissions.md) primitives.
...
To solve this, Solid Router automatically revalidates all [queries](../data-fetching/queries.md) used in the same page after a successful action.
...
To navigate the user to a new page after an action completes, the [`redirect` helper](../reference/response-helpers/redirect.md) can be used.
