...
It reports its pending state to the nearest [`<Suspense>` boundary](../../../reference/components/suspense.md) to display loading fallbacks, and propagate errors to an [`<ErrorBoundary>`](../../../reference/components/error-boundary.md) for handling and displaying error messages.
