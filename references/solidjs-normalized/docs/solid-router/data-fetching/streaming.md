...
To control this behavior, you can use suspense boundaries - regions of the component tree defined by a [`<Suspense>` component](../../reference/components/suspense.md).
