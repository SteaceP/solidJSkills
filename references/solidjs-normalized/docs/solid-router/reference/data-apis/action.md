...
`action` wraps an async function and returns an action function with router submission tracking. Matching submissions can be read with [`useSubmission`](use-submission.md) and [`useSubmissions`](use-submissions.md).
