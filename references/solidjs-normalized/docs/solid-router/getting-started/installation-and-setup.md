...
The [`Router`](../reference/components/router.md) component is the root component of the router.
It is responsible for managing the URL and rendering the appropriate [`Route`](../reference/components/route.md) based on the URL.
