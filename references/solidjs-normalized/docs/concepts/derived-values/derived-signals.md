...
To learn more about how stores work, [you can visit the stores section](../stores.md).
...
While you can create derived values in this manner, Solid created the [`createMemo`](../../reference/basic-reactivity/create-memo.md) primitive.
To dive deeper into how memos work, [check out the memos section](memos.md).
