...
Additionally, Solid's [reactive](intro-to-reactivity.md) system introduces [fine-grained reactivity](../advanced-concepts/fine-grained-reactivity.md) with JSX.
...
- **Data transfer**:
  Props are also used to fill components with data that comes from resources, like [`createResource`](../reference/basic-reactivity/create-resource.md) calls.
