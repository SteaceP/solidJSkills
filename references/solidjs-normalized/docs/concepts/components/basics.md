...
A Solid component's lifecycle is different from other frameworks, as it is tied to the [concept of reactivity](../intro-to-reactivity.md).
...
This includes setting up [signals](../signals.md), [stores](../stores.md), [effects](../effects.md), and other reactive elements.
