...
This can be done by using [`onMount`](../reference/lifecycle/on-mount.md) to wait until the element is attached to the DOM before accessing it:
...
[Signals](signals.md) can also be used as refs.
...
The [`use:`](../reference/jsx-attributes/use.md) prefix is used to denote these custom directives.
