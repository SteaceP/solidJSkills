...
[`<Dynamic>`](../../reference/components/dynamic.md) is a Solid component that allows you to render components dynamically based on data.
...
When working with these components, you can pass [props](../components/props.md) to the component you are rendering by passing them to the `<Dynamic>` component.
