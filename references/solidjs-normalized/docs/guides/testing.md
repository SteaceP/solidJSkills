...
When using [SolidStart](../solid-start/index.md), create a `vitest.config.ts` file:
...
[Directives](../reference/jsx-attributes/use.md) are reusable behaviors for elements.
