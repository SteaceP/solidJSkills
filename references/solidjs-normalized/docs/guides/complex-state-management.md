...
To create the signal so it reactively updates, you have to access the property within a tracking scope, such as using a [`createEffect`](../reference/basic-reactivity/create-effect.md):
...
```
The setter in stores follow [path syntax](../concepts/stores.md#path-syntax-flexibility): `setStore("key", value)`.
...
To solve this problem and allow for a more scalable and maintainable codebase, Solid provides [context](../concepts/context.md).
