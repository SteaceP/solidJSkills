...
- **Static Code Auditing**: Call `audit_solid_code` to detect prop destructuring, effect writing to signals, uncalled accessors, and mixed v1/v2 syntax.
...
- `component-plan.schema.json`
- `refactor-plan.schema.json`
- `review-output.schema.json`
- `scaffold-plan.schema.json`
- `design-pattern.schema.json`
...
npm run test:integration    # Runs 31-check MCP server integration suite
```
